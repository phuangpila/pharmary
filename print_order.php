...
/*
  $pdf->Cell(25,8,iconv( 'UTF-8','cp874' ,'บริษัทที่สั่งซื้อ : '),0,0,'L' );
  $pdf->Cell(110,8,iconv( 'UTF-8','cp874' ,$res_sup['supp_name']),0,0,'' );

  $pdf->Cell(20 , 8, iconv( 'UTF-8','cp874' ,'รหัสการสั่งซื้อสินค้า : '),0,0,'R' );  
  $pdf->Cell(40 , 8, iconv( 'UTF-8','cp874' ,$_GET['od_id']),0,1,'' );

  $pdf->Cell(25 , 8, iconv( 'UTF-8','cp874' ,'ที่อยู่ : '),0,0,'L' );
  $pdf->Cell(110 , 8, iconv( 'UTF-8','cp874' ,$res_sup['supp_add']),0,0,'' );

  $pdf->Cell(20 , 8, iconv( 'UTF-8','cp874' ,'Email : '),0,0,'R' );  
  $pdf->Cell(40 , 8, iconv( 'UTF-8','cp874' ,$res_sup['supp_email']),0,1,'' );

    $pdf->Cell(25 , 8, iconv( 'UTF-8','cp874' ,'เบอร์โทร : '),0,0,'L' );
  $pdf->Cell(110 , 8, iconv( 'UTF-8','cp874' ,$res_sup['supp_tel']),0,0,'' );

  $pdf->Cell(20 , 8, iconv( 'UTF-8','cp874' ,'Fax : '),0,0,'R' );  
  $pdf->Cell(40 , 8, iconv( 'UTF-8','cp874' ,$res_sup['supp_fax']),0,1,'' );


  $pdf->Cell(20,8,iconv( 'UTF-8','cp874' ,'วันที่สั่งสินค้า : '),0,0,'L' );
  $pdf->Cell(110,8,iconv( 'UTF-8','cp874' ,$res_order['date_rec']),0,1,'' );
*/
...
$pdf->Cell(35,15,iconv( 'UTF-8','cp874' ,'ราคารวม (บาท)'),1,1,'C',0);
            ...
            while ($res=mysql_fetch_array($query)) {
                ...
                $pdf->Cell(90 ,10, iconv( 'UTF-8','cp874' ,$res['od_name']),0,0,'C' );
  ...
  $pdf->Cell(130 , 8, iconv( 'UTF-8','cp874' ,'ชื่อผู้รับสินค้า '),0,1,'R' );  
