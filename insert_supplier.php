...
<form action="save_type_derug.php" method="post" name="form1">
		<div class="row">
			<div>			
				...
				<table align="center">
						<tr>
							<td>ชื่อบริษัทยา  <input type="text" name="" id="" value="" class="form-control"></td>
							<td>&nbsp;&nbsp;</td>
							<td>อีเมล์ <input type="text" name="" id="" value="" class="form-control"></td>
						</tr>
						<tr>
							<td>&nbsp;&nbsp;</td>
							<td>&nbsp;&nbsp;</td>
						...
						<tr>
							<td>เบอร์โทร <input type="date" name="" id="" value="" class="form-control"></td>
							<td>&nbsp;&nbsp;</td>
							<td>แฟกซ์ <input type="date" name="" id="" value="" class="form-control"></td>
						</tr>
						<tr>
